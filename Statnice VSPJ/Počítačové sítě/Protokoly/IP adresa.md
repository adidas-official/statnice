...
# Verze IPv6
Nástupce IPv4, kvůli nedostatku možných adres. Problém s nedostatkem se podařilo vyřešit díky [[NAT]], ale IPv6 se i tak uchytila a používá se. Obsahuje některé bezpečnostní prvky jako  [[IPsec]]. Každá IPv6 adresa na světě může být unikátní a není potřeba NAT, zařízení spolu mohou komunikovat přímo s použitím jejich veřejných IPv6 adres.